...
<template>
  <footer className="flex justify-center bg-mine-shaft">
    <div
      className="flex w-full max-w-7xl flex-col items-center justify-start gap-7 px-4 pt-16 pb-3 md:px-7 md:pb-5 xl:px-16"
    >
      ...
      <div className="flex w-full flex-col items-center justify-start gap-7 md:flex-row-reverse md:justify-between">
        ...
        <span className="text-xs text-suva-grey md:text-sm"
          >&copy; 2023 Icons by <a target="_blank" href="https://icons8.com">Icons8</a></span
        >
      </div>
    </div>
  </footer>
